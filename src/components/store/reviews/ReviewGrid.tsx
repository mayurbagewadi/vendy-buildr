          ...
          <CardContent className="p-4 md:p-5 h-full flex flex-col">
            ...
            <div className="flex items-start gap-2 mb-3">
              {review.profile_photo_url && !imageErrors[index] ? (
                ...
                <div className={`h-10 w-10 md:h-12 md:w-12 rounded-full border-2 border-white shadow-md bg-gradient-to-br ${getAvatarColor(review.author_name)} flex items-center justify-center flex-shrink-0`}>
