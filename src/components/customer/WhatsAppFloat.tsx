...
const WhatsAppFloat = ({ storeId }: WhatsAppFloatProps) => {
  ...
  return (
    <Button
      onClick={handleClick}
      className={`fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-lg hover:shadow-xl transition-none z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white p-0${shouldHop ? ' animate-whatsapp-hop' : ''}`}
