    ...
    <div className="min-h-screen bg-background font-inter overflow-x-hidden">
      ...
      {supportWhatsapp && (
        <a
          ...
          className="fixed bottom-3 right-3 sm:bottom-4 sm:right-4 md:bottom-6 md:right-6 h-14 w-14 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-[100] bg-[#25D366] hover:bg-[#20BA5A] text-white flex items-center justify-center pointer-events-auto animate-whatsapp-hop"
