    ...
    const processPayment = async () => {
      ...
      try {
        ...
        const message = generateOrderMessage({
          ...
          gstEnabled: orderData.gst_enabled,
          gstShowOnSummary: orderData.gst_show_on_summary,
          gstRate: orderData.gst_rate || 0,
          taxableAmount: orderData.taxable_amount || 0,
          gstAmount: orderData.gst_amount || 0,
